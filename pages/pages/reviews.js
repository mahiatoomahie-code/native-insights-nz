  ...
  const reviews = [
    {
      ...
      text: "Native Insights helped bring structure, clarity, and practical systems into our daily operations while still keeping our kaupapa at the centre.",
    },
    {
      name: "Community Project",
      role: "Digital & Strategic Support",
      text: "The support felt grounded, professional, and future-focused. We gained confidence using digital tools and planning our next steps.",
    },
    {
      name: "Māori Business",
      ...
      <main style={content}>
        <section style={heroBox}>
          ...
          <p style={lead}>
            ...
            organisations to strengthen systems, digital capability, strategy,
        ...
        <section style={ctaBox}>
          ...
          <p style={body}>
            As Native Insights NZ grows, this space will continue to hold
            feedback, stories, and reflections from organisations and
...
const page = {
  minHeight: "100vh",
  backgroundImage:
    "linear-gradient(rgba(3,10,5,0.82), rgba(0,0,0,0.92)), url('https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1800&q=80')",
...
const overlay = {
  ...
  inset: 0,
  background:
    "radial-gradient(circle at top left, rgba(195,164,109,0.12), transparent 30%)",
  zIndex: 0,
};
